...
const right_hand_technique_engine_1 = require("../services/right-hand-technique-engine");
let checks = 0;
...
{
    const feedback = (0, right_hand_technique_engine_1.analyzeRightHandTechniqueWindow)([
...
}
{
    ...
    const feedback = (0, right_hand_technique_engine_1.analyzeRightHandTechniqueWindow)(samples);
