...
exports.analyzeTechniqueWindow = analyzeTechniqueWindow;
const RIGHT_HAND_PICK_CATEGORIES = new Set([
    'strumming',
    'downPicking',
    'alternatePicking',
    'palmMute',
]);
const RIGHT_HAND_FINGER_CATEGORIES = new Set([
    'arpeggio',
    'fingerstyle',
]);
const LEFT_HAND_CATEGORIES = new Set([
    'chords',
    'fingering',
    'powerChords',
    'scales',
...
function analyzeTechniqueWindow(samples) {
    ...
    const wristTravel = Math.hypot(range(recent.map((sample) => sample.wristX)), range(recent.map((sample) => sample.wristY))) / averagePalm;
