...
exports.rawPalmSize = rawPalmSize;
exports.effectiveHandDetailSize = effectiveHandDetailSize;
exports.hasUsableHandDetail = hasUsableHandDetail;
exports.decideHandPrecisionRegion = decideHandPrecisionRegion;
const clamp = (value, minimum, maximum) => Math.min(maximum, Math.max(minimum, value));
function fitAxis(center, requestedSize) {
