...
function shouldPublishForCoach(result, _pickColor) {
    ...
    if (leftHandCategory)
        return (0, hand_precision_region_1.hasUsableHandDetail)(result);
...
async function analyzeHandWithStringsAsync(uri, pickColor, options = {}) {
    ...
    const shouldRefresh = (0, hand_string_analysis_policy_1.shouldRefreshStringVision)({
