...
exports.getSongChordGuide = getSongChordGuide;
exports.chordAtSectionProgress = chordAtSectionProgress;
...
function getSongChordGuide(songId, sectionId, mode, capoOverride) {
    ...
    const capo = capoOverride == null ? preset.defaultCapo : (0, song_sheet_engine_1.normalizeCapo)(capoOverride);
    const soundingChords = chords.map((chord) => (0, song_sheet_engine_1.transposeChord)(chord, capo));
    ...
    return {
        ...
        shapeKey: preset.shapeKey, soundingKey: capo === preset.defaultCapo ? preset.soundingKey : (0, song_sheet_engine_1.transposeChord)(preset.shapeKey, capo),
...
function chordAtSectionProgress(chords, progress, beatWeights) {
    if (!chords.length)
