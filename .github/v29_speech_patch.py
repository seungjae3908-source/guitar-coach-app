...
speech_path = Path("mobile/modules/guitar-coach-native/android/src/main/java/expo/modules/guitarcoachnative/GuitarCoachSpeechModule.kt")
speech_path.write_text(r'''package expo.modules.guitarcoachnative
...
index_path = Path("mobile/modules/guitar-coach-speech/index.ts")
